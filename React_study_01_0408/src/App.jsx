...
import { AuthContext } from './components/SideEffect/Store/AuthContext';
...
const App = () => {
  ...
  // 로그인 상태를 관리하는 변수
  const { isLoginValid, changeLoginStatus } = useContext(AuthContext);
  ...
  return (
    // Context를 생성했다면 전역 상태를 사용하고자 하는 컴포넌트를 Provider로 감싸줌.
    <>
